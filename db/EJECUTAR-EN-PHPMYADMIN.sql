-- ============================================
-- SISTEMA DE CUPONES Y HISTORIAL DE PEDIDOS
...
-- Modificar tabla pedidos para agregar columnas de cupón
-- (Si ya existen estas columnas, se pueden omitir estos ALTER TABLE)

-- Verificar primero si las columnas existen:
-- SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS 
-- WHERE TABLE_SCHEMA = 'fit_fuel' AND TABLE_NAME = 'pedidos' 
-- AND COLUMN_NAME IN ('cupon_id', 'descuento', 'subtotal');

-- Si NO existen, ejecutar estos ALTER TABLE:
ALTER TABLE pedidos 
ADD COLUMN cupon_id INT UNSIGNED DEFAULT NULL,
...
SELECT COUNT(*) as Total_Cupones_Activos FROM cupones WHERE activo = 1;
SELECT codigo, tipo_descuento, valor_descuento, monto_minimo FROM cupones WHERE activo = 1;
